...
class Review(TypedDict):
    ...
    sentiments: Annotated[Literal["pos", "neg"], "Return the sentiment of the review either positive, negative or neutral"]
    ...
    name: Annotated[Optional[str], "If reviewer name not found return null. Example: null"]
